...
var _partyPostPC = {
  ...
  _postFront: function(id, isprev) {
    var _detailAddr = $("#post_party_place_site_" + _post._tempId).val(),
      ...
      _timeSummaryEnd = _startymd + _starthm + _overymd + _overhm + _endymd + _endhm,
    ...
    if (_partyPostPC._ifTitle == false || _partyPostPC._ifrichText == false || _partyPostPC._ifTime1 == false || _partyPostPC._ifTime2 == false || _partyPostPC._ifAddress == false || _partyPostPC._ifpleLimit == false || _partyPostPC._ifStyle == false) {
      $("body,html").animate({
  ...
  _post: function(id, isprev) {
    ...
    if (_partyPostPC._isprev == 1) {
      ...
      _$(_postApi._partyPreview, "update_id=" + (_post._id || "") + "&title=" + _._htmlencode(_._encode(_partyPostPC._title)) + "&content=" + _._encode(_partyPostPC._content) + "&join_property_id=" +
        ...
        "&need_party_support=" + _partyPostPC._needPartySupport + "&party_support_mobile=" + _partyPostPC._partySupportMobile, _partyPostPC._ok);
    } else {
      //发布
      var param = "update_id=" + (_post._id || "") + "&title=" + _._htmlencode(_._encode(_partyPostPC._title)) + "&content=" + _._encode(_partyPostPC._content) + "&join_property_id=" +
        ...
        "&need_party_support=" + _partyPostPC._needPartySupport + "&party_support_mobile=" + _partyPostPC._partySupportMobile;
  ...
  _ok: function(json, code) {
    ...
    if ((navigator.userAgent.indexOf('MSIE') >= 0) && (navigator.userAgent.indexOf('Opera') < 0)) {
      _postDetail("/party/" + json.party_id + ".html?view=" + isview);
    } else {
      _g("/party/" + json.party_id + ".html?view=" + isview);
    }
    if (_partyPostPC._winOpen != null) {
      _partyPostPC._winOpen.close();
    }
      ...
      if (zhi == "0") { //免费
        ...
        if (_post._id != "") { //免费编辑成收费
          ...
          if (_post._isautoPay == "false") {
            ...
            $("#party_" + _post._tempId + "_pay_item_price_1").attr("readonly", "readonly");
...
var _articlePostPC = {
  ...
  _post: function(id, isprev) {
    ...
    if (_articlePostPC._isprev == 1) {
      ...
      _$(_postApi._article, "update_id=" + (id || "") + "&title=" + _._encode(_title) + "&content=" + _._encode(_content) + "&private=" + _private + "&scene_id=" + _post._sceneId, _articlePostPC._ok);
    }
  },
  _ok: function(json, code) {
    _loading._hide();
...
$(document).ready(function() {
  ...
  if (_post._type == "party") {
    ...
    if (_t._get("post_party_setJoinobj_" + _post._tempId + "_" + _post._sceneId + _post._id) != "") {
      ...
      for (i = 0; i < obj.length; i++) {
        if (obj[i].classN.indexOf("name") != -1) { //姓名
          _txxHtml += '<li datatype="text" sortid="' + (i + 1) + '" businessid="' + obj[i].businessid + '" id="' + _idFront + '' + (i + 1) + '" class="' + obj[i].classN + '">' + '<div class="joinxx_px_handle"><div class="yinyingQu"><span class="icon"></span><div datatitle="" class="bdNr">姓名</div></div>' + '<div class="czQu2"><img src="http://img1.hudongba.com/static_v4/images/detail/subinfo_pic_check.png" alt="" /></div></div></li>';
        } else if (obj[i].classN.indexOf("phone") != -1) { //手机
          _txxHtml += '<li datatype="text" sortid="' + (i + 1) + '" businessid="' + obj[i].businessid + '" id="' + _idFront + '' + (i + 1) + '" class="' + obj[i].classN + '">' + '<div class="joinxx_px_handle"><div class="yinyingQu"><span class="icon"></span><div datatitle="" class="bdNr">手机</div></div>' + '<div class="czQu"><a onclick="isFetchJoinOpt(this);_setJoinobj._init();" class="' + obj[i].ifPhone + '" href="javascript:void(0)"></a></div></div></li>';
        } else if (obj[i].classN.indexOf("danH") != -1) { //单行文本
          _txxHtml += '<li datatype="text" sortid="' + (i + 1) + '" businessid="' + obj[i].businessid + '" id="' + _idFront + '' + (i + 1) + '" class="' + obj[i].classN + '">' + '<div class="joinxx_px_handle"><div class="yinyingQu"><span class="icon"></span><div class="bdNr"><div class="xuanTit">' + '<input name="" type="text" placeholder="单行文本标题" class="wek_gray" dataTitle="" maxlength="20" value="' + obj[i].title + '" oninput="_setJoinobj._init()" onpropertychange="_setJoinobj._init()" onchange="_setJoinobj._init()"/></div></div><div class="tsIe" >单行文本标题</div></div>' + '<div class="czQu"><a href="javascript:void(0)" class="del" onclick="_addFill._del(\'' + _idFront + '' + (i + 1) + '\')" title="删除"></a></div></div></li>';
        } else if (obj[i].classN.indexOf("duoH") != -1) { //多行文本
          _txxHtml += '<li datatype="' + obj[i].datatype + '" sortid="' + (i + 1) + '" businessid="' + obj[i].businessid + '" id="' + _idFront + '' + (i + 1) + '" class="' + obj[i].classN + '">' + '<div class="joinxx_px_handle"><div class="yinyingQu"><span class="icon"></span><div class="bdNr"><div class="xuanTit">' + '<input name="" type="text" placeholder="这是一个多行文本框" class="wek_gray" dataTitle=""  maxlength="20" value="' + obj[i].title + '" oninput="_setJoinobj._init()" onpropertychange="_setJoinobj._init()" onchange="_setJoinobj._init()"/></div></div><div class="tsIe" >这是一个多行文本框</div></div>' + '<div class="czQu"><a href="javascript:void(0)" class="del" onclick="_addFill._del(\'' + _idFront + '' + (i + 1) + '\')" title="删除"></a></div></div></li>';
        } else if (obj[i].classN.indexOf("danX") != -1) { //单选问题
          _txxHtml += '<li datatype="' + obj[i].datatype + '" sortid="' + (i + 1) + '" businessid="' + obj[i].businessid + '" id="' + _idFront + '' + (i + 1) + '" class="' + obj[i].classN + '">' + '<div class="joinxx_px_handle"><div class="yinyingQu"><span class="icon"></span><div class="bdNr"><div class="xuanTit">' + '<input name="" type="text" placeholder="这是一个单选问题" class="wek_gray" dataTitle=""  maxlength="30" value="' + obj[i].title + '" oninput="_setJoinobj._init()" onpropertychange="_setJoinobj._init()" onchange="_setJoinobj._init()"/></div><div class="xuan_Li">';
          for (y = 0; y < obj[i].xuanXiang.length; y++) {
            _txxHtml += '<p class="xuan_Li_P"><span>选项' + (y + 1) + '</span><input id="' + _idFront + '' + (i + 1) + '_dan_' + (y + 1) + '" value="' + obj[i].xuanXiang[y] + '" name="" type="text" placeholder="这是一个单选问题" class="wek_gray2" maxlength="50" oninput="_setJoinobj._init()" onpropertychange="_setJoinobj._init()" onchange="_setJoinobj._init()"/>' + '<a href="javascript:void(0)" class="xuan_Li_P_A" onclick="_addFill._delxuanLi(\'' + _idFront + '' + (i + 1) + '_dan_' + (y + 1) + '\')">' + '<img src="http://img1.hudongba.com/static_v4/images/post/share_qr_close3_15.png" alt="" /></a></p>';
          }
          _txxHtml += '</div><div class="addBtn"><a href="javascript:void(0)" onclick="_addFill._addXxdan(\'' + _idFront + '' + (i + 1) + '\')" title="添加选项"></a></div></div><div class="tsIe">这是一个单选问题</div></div>' + '<div class="czQu"><a href="javascript:void(0)" class="del" onclick="_addFill._del(\'' + _idFront + '' + (i + 1) + '\')" title="删除"></a></div></div></li>';
        } else if (obj[i].classN.indexOf("duoX") != -1) { //多选问题
          _txxHtml += '<li datatype="' + obj[i].datatype + '" sortid="' + (i + 1) + '" businessid="' + obj[i].businessid + '" id="' + _idFront + '' + (i + 1) + '" class="' + obj[i].classN + '">' + '<div class="joinxx_px_handle"><div class="yinyingQu"><span class="icon"></span><div class="bdNr"><div class="xuanTit">' + '<input name="" type="text" placeholder="这是一个多选问题" class="wek_gray" dataTitle=""  maxlength="30" value="' + obj[i].title + '" oninput="_setJoinobj._init()" onpropertychange="_setJoinobj._init()" onchange="_setJoinobj._init()"/></div><div class="xuan_Li">';
          for (y = 0; y < obj[i].xuanXiang.length; y++) {
            _txxHtml += '<p class="xuan_Li_P"><span>选项' + (y + 1) + '</span><input id="' + _idFront + '' + (i + 1) + '_duo_' + (y + 1) + '" value="' + obj[i].xuanXiang[y] + '" name="" type="text" placeholder="这是一个多选问题" class="wek_gray2" maxlength="50" oninput="_setJoinobj._init()" onpropertychange="_setJoinobj._init()" onchange="_setJoinobj._init()"/>' + '<a href="javascript:void(0)" class="xuan_Li_P_A" onclick="_addFill._delxuanLi(\'' + _idFront + '' + (i + 1) + '_duo_' + (y + 1) + '\')">' + '<img src="http://img1.hudongba.com/static_v4/images/post/share_qr_close3_15.png" alt="" /></a></p>';
          }
          _txxHtml += '</div><div class="addBtn"><a href="javascript:void(0)" onclick="_addFill._addXxduo(\'' + _idFront + '' + (i + 1) + '\')" title="添加选项"></a></div></div><div class="tsIe">这是一个多选问题</div></div>' + '<div class="czQu"><a href="javascript:void(0)" class="del" onclick="_addFill._del(\'' + _idFront + '' + (i + 1) + '\')" title="删除"></a></div></div></li>';
        }
      }
      if (_post._id == "") {
    ...
    if (_post._id != "" && _post._isautoPay == "false" && $(".cost_content").length == "1") {
      ...
      $(".cost_content .form_input_cost_money .input").val("0").attr("readonly", "readonly");
  ...
  $(".post_title,.form_input input,.wek_gray,.form_input_cost input,#post_party_meet_tel,.post_main_fee_K input").focus(function() {
    $(this).addClass("blue");
  }).blur(function() {
    $(this).removeClass("blue");
  });
